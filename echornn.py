...
def plot(loss_list,prediction_series,batchX,batchY):
    ...
    for batch_series_idx in range(5):
        one_hot_encoded_series=np.array(prediction_series)[:,batch_series_idx,:]
        single_output_series=np.array([(1 if out[0]<0.5 else 0) for out in one_hot_encoded_series])
